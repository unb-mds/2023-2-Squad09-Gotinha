...
# Executa o spider e obtém os decretos em .json
# Lembre-se de navegar pelo terminal até o diretório correto
...
output_file_path = os.path.join(script_dir, f"Decretos por Ano/decretos_{year}.json")

# Renomeia o arquivo JSON gerado pelo scrapy para o caminho desejado
os.rename(f"Decretos por Ano/decretos_{year}.json", output_file_path)
